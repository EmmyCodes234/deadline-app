...
import { type CryptItem, type Snapshot } from '@/hooks/useCrypt';
...
interface SnapshotsModalProps {
  ...
  onTakeSnapshot: () => void;
  onRevertToSnapshot: (snapshotId: string) => void;
...
export function SnapshotsModal({
  ...
  const snapshots = activeDocument.snapshots || [];
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm">
      <div className="bg-stone-900 border-2 border-purple-500/50 rounded-lg shadow-2xl shadow-purple-500/20 w-full max-w-4xl max-h-[90vh] overflow-hidden flex flex-col">
        {/* Header */}
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-stone-500 font-serif italic mt-1">
                  Echoes of "{activeDocument.title}"
                </p>
              </div>
            </div>
            <button
